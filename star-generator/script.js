...
(function() {
   ...
   var controls, scene, camera, renderer, geometry, material, sphere, spriteMaterial, sprite, ambient, urls, cubemap, shader, shaderMaterial, skybox;
    ...
    function xyzToRgb(xyz) {
        var r, g, b, x = xyz[0], y = xyz[1], z = xyz[2];
    ...
    function gammaCorrect(rgb) {
        var a = 0.055, gamma = 2.2, R, G, B, r = rgb[0], g = rgb[1], b = rgb[2];
        R = r;
        G = g / 1.05;
        B = b;
        R = R > 1 ? 1 : R;
    ...
    function transfromStarData(star) {
      ...
      star.rotation = star.speed / 10000;
    ...
    function newStar(star) {
      ...
      ambient = new THREE.AmbientLight(STAR_BRIGHTNESS_COLOR);
  ...
  updateStar({colorb_v: 2, label: 'Sun', speed: 0, lum: 0.8913});
